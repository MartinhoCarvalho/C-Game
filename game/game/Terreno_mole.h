...
class Terreno_mole:public Bloco{
	private:

	public:
		Terreno_mole(void);
		Terreno_mole(const Terreno_mole &ob);
		~Terreno_mole(void);
		//########################## Encapsulamento ##########################
		...
		virtual Terreno_mole &operator=(const Bloco &b);
		...
		virtual void cor(void){ Consola c; c.setTextColor(c.BRANCO_CLARO);}
		/*################  Polimorfismo ################################*/
};
