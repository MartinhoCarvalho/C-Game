...
class Terreno_Duro:public Bloco{
	private:
	
	public:
		Terreno_Duro(void);
		Terreno_Duro(const Terreno_Duro &ob);
		~Terreno_Duro(void);
		//########################## Encapsulamento ##########################
		...
		virtual Terreno_Duro &operator=(const Bloco &b);
		...
		virtual void cor(void){ Consola c; c.setTextColor(c.BRANCO);}
		/*################  Polimorfismo ################################*/
};
