...
class Terra_Carvao:public Bloco{
	private:

	public:
		Terra_Carvao(void);
		Terra_Carvao(const Terra_Carvao &ob);
		~Terra_Carvao(void);			
		//########################## Encapsulamento ##########################
		...
		virtual Terra_Carvao &operator=(const Bloco &b);
		...
		virtual void cor(void){ Consola c; c.setTextColor(c.COR_DE_ROSA);}
		/*################  Polimorfismo ################################*/
};
