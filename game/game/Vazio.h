...
class Vazio:public Bloco{
	private:

	public:
		Vazio(void);
		Vazio(const Vazio &ob);
		~Vazio(void);
		//########################## Encapsulamento ##########################
		...
		virtual void set_valr(int &numero){ this->valor = numero;}
		//########################## Encapsulamento ##########################
		/*################  Polimorfismo ################################*/
		...
		//operator =
		virtual Vazio &operator=(Bloco &b);//operator programado derivado 
