...
class Terra_frango : public Bloco{
	private:

	public:
		Terra_frango(void);
		Terra_frango(const Terra_frango &ob);
		~Terra_frango(void);
		//########################## Encapsulamento ##########################
		...
		virtual Terra_frango &operator=(const Bloco &b);
		...
		virtual void cor(void){ Consola c; c.setTextColor(c.VERMELHO_CLARO) ;}
		/*################  Polimorfismo ################################*/
};
