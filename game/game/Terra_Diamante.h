...
class Terra_Diamante:public Bloco{
	private:

	public:
		Terra_Diamante(void);
		Terra_Diamante(const Terra_Diamante &ob);
		~Terra_Diamante(void);
		//########################## Encapsulamento ##########################
		...
		virtual Terra_Diamante &operator=(const Bloco &b);
		...
		virtual void cor(void){ Consola c; c.setTextColor(c.VERDE_CLARO);}
		/*################  Polimorfismo ################################*/
};
