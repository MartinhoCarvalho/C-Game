...
class Terra_Ouro:public Bloco{
	private:

	public:
		Terra_Ouro(void);
		Terra_Ouro(const Terra_Ouro &ob);
		~Terra_Ouro(void);
		//########################## Encapsulamento ##########################
		...
		virtual Terra_Ouro &operator=(const Bloco &b);
		...
		virtual void cor(void){ Consola c; c.setTextColor(c.AMARELO);}
		/*################  Polimorfismo ################################*/
};
