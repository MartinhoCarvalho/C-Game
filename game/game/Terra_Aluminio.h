...
class Terra_Aluminio: public Bloco{
	private:

	public:
		Terra_Aluminio(void);
		Terra_Aluminio(const Terra_Aluminio &ob);
		~Terra_Aluminio(void);			
		//########################## Encapsulamento ##########################
		...
		virtual Terra_Aluminio &operator=(const Bloco &b);
		...
		virtual void cor(void){ Consola c; c.setTextColor(c.AZUL_CLARO);}
};
